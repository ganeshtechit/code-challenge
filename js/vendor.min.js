...
//banner slider custom js
jssor_1_slider_init=function(){var s={$AutoPlay:1,$SlideshowOptions:{$Class:$JssorSlideshowRunner$,$Transitions:[],$TransitionsOrder:1},$BulletNavigatorOptions:{$Class:$JssorBulletNavigator$},$ThumbnailNavigatorOptions:{$Class:$JssorThumbnailNavigator$}},i=new $JssorSlider$("jssor_1",s),o=2e3;function n(){var s=i.$Elmt.parentNode.clientWidth;if(s){var t=Math.min(o||s,s);i.$ScaleWidth(t)}else window.setTimeout(n,30)}n(),$Jssor$.$AddEvent(window,"load",n),$Jssor$.$AddEvent(window,"resize",n),$Jssor$.$AddEvent(window,"orientationchange",n)};
